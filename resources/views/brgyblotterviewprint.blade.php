        ...
        <div class="bg-white overflow-hidden sm:rounded-lg shadow-lg ">
            ...
            <div class="grid grid-cols-12 mx-5 mb-5 border-2 border-slate-200">
                <div class="col-span-12 py-1 flex justify-end pr-3">
                    <button type="button" class="print:hidden text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-1.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mr-3">EDIT</button>
