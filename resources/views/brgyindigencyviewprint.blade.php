        ...
        <div class="bg-white overflow-hidden sm:rounded-lg shadow-lg ">
            ...
            <div class="grid grid-cols-12 mx-5 pb-2">
                ...
                <div class="col-span-9 border-2 border-slate-200">
                    ...
                    <p class="text-base text-center font-bold"> BARANGAY INDIGENCY</p>

                    <p class="text-xs pt-3 px-5 pb-2"> TO WHOM IT MAY CONCERN, </p>
                    <p class="text-xs px-5 indent-8 pb-5"> This is to <strong>CERTIFY</strong> that the person whose name appearing herein has requested a 
                        <strong> BARANGAY INDIGENCY </strong> from the office and the result(s) is/are listed below:
                    </p>
                    ...
                    <p class="text-xs px-5 indent-8 pb-5"> 	It is <strong> FURTHER CERTIFIED </strong> that <strong> Monkey D. Luffy </strong> who is known to the undersigned, 
                        is a person of good character, a law-abiding citizen and has neither nor criminal record/s in this barangay as of 
                        this date and is one of the <strong>INDIGENT</strong> fellow in our community.
                    </p>

                    <p class="text-xs px-5 indent-8 pb-5"> 	This <strong>CERTIFICATION</strong> is being issued upon the request of the above-named person 
                        for whatever legal puspose it may serve him/her. 
                    </p>
            ...
            <div class="grid grid-cols-12 mx-5 mb-5 border-2 border-slate-200">
                <div class="col-span-10  pb-2 px-3">
                    ...
                    <p class="text-xs font-semibold indent-8">Barangay Indigency Issuance, etc.</p>
                </div>
