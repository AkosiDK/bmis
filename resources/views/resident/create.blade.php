                                        ...
                                        <div class="py-5">
                                            <div class="grid grid-cols-9 gap-x-5">
                                                ...
                                                <div class="pb-5">
                                                    ...
                                                    <input type="name" name="suffix" id="suffix" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Jr." required>
                                                </div>
                                                <div class="pb-5">
                                                    <label for="alias" class="mb-5 text-sm font-medium text-gray-900 dark:text-white">Alias</label>
                                                    <input type="name" name="alias" id="alias" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="DA" required>
                                                </div>
                                                <div class="pb-5">
                                                ...
                                                <div class="pb-5 col-span-2">
                                                    ...
                                                    <input type="date" name="birthdate" id="birthdate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="01/01/2001" required>
                                                </div>
                                        ...
                                        <div class="py-5">
                                            <div class="grid grid-cols-4 gap-x-5">
                                                ...
                                                <div class="pb-5">
                                                    ...
                                                    <input type="text" name="officeaddress" id="officeaddress" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Zone 6B, Baluarte, Tagoloan, Mis. Or." required>
                                                </div>
                                                <div class="pb-5">
                                                    <label for="employer" class="mb-5 text-sm font-medium text-gray-900 dark:text-white">Employer Name</label>
                                                    <input type="text" name="employer" id="employer" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Juan Dela Cruz" required>
                                                </div>
                                                <div class="pb-5">
