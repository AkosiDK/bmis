<x-app-layout>
    ...
    <div class="">
        <div class="mx-auto">
            <div class="border-b border-gray-200 dark:border-gray-700 mb-4">
                <ul class="flex flex-wrap" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                    <div class="grid grid-cols-4 gap-5">
                                    ...
                                    <div class="mx-auto  p-5" style="width: 100; height:150px;">
                                        ...
                                        <div class="grid grid-cols-12">
                                            <div class="col-span-12">
                                                <p class="text-white text-end text-xs pt-8 tracking-widest">Total Clearance Request</p>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                        ...
                        <div class="col-span-1">
                            <li role="presentation">
                                <button class="rounded-lg drop-shadow-xl bg-green-600 hover:bg-green-700 active:bg-green-800 focus:outline-none focus:ring focus:ring-green-500" id="totalindigency-tab" data-tabs-target="#totalindigency" role="tab" aria-controls="totalindigency" aria-selected="false">
                                    <div class="mx-auto  p-5" style="width: 100; height:150px;">
                                        <div class="grid grid-cols-12">
                                            <div class="col-span-11">
                                                <p class="font-bold text-white text-start dashboardcounter" data-target="7000" style="font-size:25px;">0</p>
                                                <p class="text-white text-start">INDIGENCY</p>
                                            </div>
                                            <div>
                                        ...
                                        <div class="grid grid-cols-12">
                                            <div class="col-span-12">
                                                <p class="text-white text-end text-xs pt-8 tracking-widest">Total Indigency Request</p>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                        ...
                        <div class="col-span-1">
                            <li role="presentation">
                                <button class="rounded-lg drop-shadow-xl bg-yellow-500 hover:bg-yellow-600 active:bg-yellow-700 focus:outline-none focus:ring focus:ring-yellow-400" id="totalresidency-tab" data-tabs-target="#totalresidency" role="tab" aria-controls="totalresidency" aria-selected="false">
                                    <div class="mx-auto  p-5" style="width: 100; height:150px;">
                                        <div class="grid grid-cols-12">
                                            <div class="col-span-11">
                                                <p class="font-bold text-white text-start dashboardcounter" data-target="6000" style="font-size:25px;">0</p>
                                                <p class="text-white text-start">RESIDENCY</p>
                                            </div>
                                            <div>
                                        ...
                                        <div class="grid grid-cols-12">
                                            <div class="col-span-12">
                                                <p class="text-white text-end text-xs pt-8 tracking-widest">Total Residency Request</p>
                                            </div>
                                        </div>
                                    </div>
                                </button>
                        ...
                        <div class="col-span-1">
                            <li role="presentation">
                                <button class="rounded-lg drop-shadow-xl bg-red-500 hover:bg-red-600 active:bg-red-700 focus:outline-none focus:ring focus:ring-red-400" id="totalresidentid-tab" data-tabs-target="#totalresidentid" role="tab" aria-controls="totalresidentid" aria-selected="false">
                                    <div class="mx-auto  p-5" style="width: 100; height:150px;">
                                        <div class="grid grid-cols-12">
                                            <div class="col-span-11">
                                                <p class="font-bold text-white text-start dashboardcounter" data-target="5000" style="font-size:25px;">0</p>
                                                <p class="text-white text-start">RESIDENT ID</p>
                                            </div>
                                            <div>
                                        ...
                                        <div class="grid grid-cols-12">
                                            <div class="col-span-12">
                                                <p class="text-white text-end text-xs pt-8 tracking-widest">Total Resident ID Request</p>
                                            </div>
                                        </div>
                                    </div>
                                </button>
            ...
            <div id="myTabContent">
                <div class="grid grid-cols-12 gap-x-5 rounded-lg" id="totalclearance" role="tabpanel" aria-labelledby="totalclearance-tab">
                    <div class="col-span-12">
                        <div class="bg-white dark:bg-gray-800 rounded-lg">
                            <div class="grid grid-cols-12">
                                <div class="col-span-9 py-6 px-5">
                                    <div class="text-xl font-bold text-start">Barangay Clearance Request</div>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-gray-100 dark:bg-gray-800">
                                        ...
                                        <td class="px-6 py-2 text-clip overflow-hidden ...">
                                            ...
                                            <script>
                                                const selectclearance = document.querySelector('select');
                                                selectclearance.addEventListener('change', function() {
                                                    if (this.value === 'Pending') {
                                                        selectclearance.style.backgroundColor = 'red';
                                                        selectclearance.style.color = 'white';
                                                    } else if (this.value === 'Done') {
                                                        selectclearance.style.backgroundColor = 'green';
                                                        selectclearance.style.color = 'white';
                                                    } else {
                                                        selectclearance.style.backgroundColor = '';
                                                        selectclearance.style.color = '';
                                                    }
                                                });
                                            </script>
                ...
                <div class="grid grid-cols-12 gap-x-5 hidden" id="totalindigency" role="tabpanel" aria-labelledby="totalindigency-tab">
                <div class="col-span-12">
                        <div class="bg-white dark:bg-gray-800 rounded-lg">
                            <div class="grid grid-cols-12">
                                <div class="col-span-9 py-6 px-5">
                                    <div class="text-xl font-bold text-start">Barangay Indigency Request</div>
                                </div>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-gray-100 dark:bg-gray-800">
                                        ...
                                        <td class="px-6 py-2 text-clip overflow-hidden ...">
                                            Para po sana hingi ng medical assistance.
                                        </td>
                                        <td class="px-6 py-2 text-clip overflow-hidden ...">
                                            <select class="bg-blue-600 border border-blue-300 text-white text-sm rounded focus:ring-blue-600 focus:border-blue-600 block w-full px-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-600 dark:focus:border-blue-600">
                                                <option>Select Status</option>
                                            ...
                                            <script>
                                                const selectindigency = document.querySelector('select');
                                                selectindigency.addEventListener('change', function() {
                                                    if (this.value === 'Pending') {
                                                        selectindigency.style.backgroundColor = 'red';
                                                        selectindigency.style.color = 'white';
                                                    } else if (this.value === 'Done') {
                                                        selectindigency.style.backgroundColor = 'green';
                                                        selectindigency.style.color = 'white';
                                                    } else {
                                                        selectindigency.style.backgroundColor = '';
                                                        selectindigency.style.color = '';
                                                    }
                                                });
                                            </script>
                ...
                <div class="grid grid-cols-12 gap-x-5 hidden" id="totalresidency" role="tabpanel" aria-labelledby="totalresidency-tab">
                <div class="col-span-12">
                        <div class="bg-white dark:bg-gray-800 rounded-lg">
                            <div class="grid grid-cols-12">
                                <div class="col-span-9 py-6 px-5">
                                    <div class="text-xl font-bold text-start">Barangay Residency Request</div>
                                </div>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-gray-100 dark:bg-gray-800">
                                        ...
                                        <td class="px-6 py-2 text-clip overflow-hidden ...">
                                            Para po sana makapag apply ng voters ID.
                                        </td>
                                        <td class="px-6 py-2 text-clip overflow-hidden ...">
                                            <select class="bg-blue-600 border border-blue-300 text-white text-sm rounded focus:ring-blue-600 focus:border-blue-600 block w-full px-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-600 dark:focus:border-blue-600">
                                                <option>Select Status</option>
                                            ...
                                            <script>
                                                const selectresidency = document.querySelector('select');
                                                selectresidency.addEventListener('change', function() {
                                                    if (this.value === 'Pending') {
                                                        selectresidency.style.backgroundColor = 'red';
                                                        selectresidency.style.color = 'white';
                                                    } else if (this.value === 'Done') {
                                                        selectresidency.style.backgroundColor = 'green';
                                                        selectresidency.style.color = 'white';
                                                    } else {
                                                        selectresidency.style.backgroundColor = '';
                                                        selectresidency.style.color = '';
                                                    }
                                                });
                                            </script>
                ...
                <div class="grid grid-cols-12 gap-x-5 hidden" id="totalresidentid" role="tabpanel" aria-labelledby="totalresidentid-tab">
                <div class="col-span-12">
                        <div class="bg-white dark:bg-gray-800 rounded-lg">
                            <div class="grid grid-cols-12">
                                <div class="col-span-9 py-6 px-5">
                                    <div class="text-xl font-bold text-start">Barangay Resident ID Request</div>
                                </div>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-gray-100 dark:bg-gray-800">
                                        ...
                                        <td class="px-6 py-2 text-clip overflow-hidden ...">
                                            Kukuha lang po sana ng brgy ID.
                                        </td>
                                        <td class="px-6 py-2 text-clip overflow-hidden ...">
                                            <select class="bg-blue-600 border border-blue-300 text-white text-sm rounded focus:ring-blue-600 focus:border-blue-600 block w-full px-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-600 dark:focus:border-blue-600">
                                                <option>Select Status</option>
                                            ...
                                            <script>
                                                const selectresidentid = document.querySelector('select');
                                                selectresidentid.addEventListener('change', function() {
                                                    if (this.value === 'Pending') {
                                                        selectresidentid.style.backgroundColor = 'red';
                                                        selectresidentid.style.color = 'white';
                                                    } else if (this.value === 'Done') {
                                                        selectresidentid.style.backgroundColor = 'green';
                                                        selectresidentid.style.color = 'white';
                                                    } else {
                                                        selectresidentid.style.backgroundColor = '';
                                                        selectresidentid.style.color = '';
                                                    }
                                                });
                                            </script>
